        ...
        <div className="flex-1 p-4 mt-5">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center">
              <span className="text-white text-lg font-bold text-5xl">{roomDetail.title}</span>
              <span className="text-white text-lg font-bold text-2xl">{roomDetail.majorCategory} - {roomDetail.subCategory}</span>
            </div>
          </div>
